...
<head>
    ...
    <title>Admin - Library Personnel</title>
    <?php include "./components/admin/admin-links.php" ?>

</head>
<?php $_GET['page'] = "admin-personnel" ?>
                ...
                <div class="p-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center p-4">
                            <h1 class="fs-4 p-0 m-0">Library Personnel</h1>
                            <div class="d-flex gap-3 align-items-center">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#addPersonnelModal"
                        ...
                        <div class="card-body px-4">
                            <table id="personnel_table" class="table table-hover table-bordered data-table">
