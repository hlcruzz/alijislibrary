...
<head>
    ...
    <title>Admin - Online Reference Tools</title>
    <?php include "./components/admin/admin-links.php" ?>

</head>
<?php $page = "online-reference-tools" ?>
            ...
            <div class="content flex-grow-1">
                ...
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="fs-3 p-0 m-0">Online Reference Tools</h1>
                        <button type="button" data-bs-toggle="modal" data-bs-target="#addToolModal"
                            class="btn btn-success d-flex align-items-center gap-2"><span
                                ...
                                add
                            </span> Add Online Tools</button>
                    </div>
                    <div class="card mt-3">
                        <div class="card-body px-4">
                            <table id="online_tools_table" class="table table-hover table-bordered">
