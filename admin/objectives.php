...
<head>
    ...
    <title>Admin - Objectives</title>
    <?php include "./components/admin/admin-links.php" ?>
</head>
<?php $page = "settings-objectives" ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center pb-4">
                                <h1 class="fs-3 p-0 m-0">Library Objectives</h1>
                            ...
                            <div class="card">
                                <div class="card-body px-4">
                                    <table id="table_Objectives" class="table table-hover table-bordered">
                                    </table>
                                </div>
                            </div>
                        </div>
