...
<head>
    ...
    <title>Admin - New Arrival: Periodicals</title>
    <?php include "./components/admin/admin-links.php" ?>

</head>
<?php $_GET['page'] = "admin-periodicals" ?>
        ...
        <div class="d-flex">
            ...
            <div class="content flex-grow-1">
                ...
                <div class="p-4 d-flex flex-column gap-4">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="fs-3 p-0 m-0">New Arrival: Periodicals</h1>
                            <div class="card mt-3">
                                <div class="card-header d-flex justify-content-between align-items-center p-4">
                                    <h1 class="fs-4 p-0 m-0">Magazines & Journals</h1>
                                    <div class="d-flex gap-3 align-items-center">
                                        <button type="button" data-bs-toggle="modal"
                                            data-bs-target="#addPeriodicalModal"
                                ...
                                <div class="card-body px-4">
                                    <table id="table_periodicals" class="table table-hover table-bordered data-table">
