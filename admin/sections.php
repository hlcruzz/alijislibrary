...
<head>
    ...
    <title>Admin - Library Sections</title>
    <?php include "./components/admin/admin-links.php" ?>

</head>
<?php $_GET['page'] = "admin-sections" ?>
                        ...
                        <div class="col-12">
                            <div class="card mt-3">
                                <div class="card-header d-flex justify-content-between align-items-center p-4">
                                    <h1 class="fs-4 p-0 m-0">Library Sections</h1>
                                ...
                                <div class="card-body px-4">
                                    <table id="table_sections" class="table table-hover table-bordered data-table">
