...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    $condition1 = $search == "" ? "WHERE library_news.status = 1" : 'WHERE (library_news.library_news_subject LIKE :search OR library_news.library_news_txt LIKE :search) AND library_news.status = 1';
