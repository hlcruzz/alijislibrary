...
<body class="overflow-x-hidden">
  ...
  <!-- CONTENT -->
  <div class="container-fluid p-0" id="program1">
  ...
  <div class="container-fluid pb-5" id="program2">
    <div class="container-lg">
      <div class="text-center pt-5 mb-4">
        <h1 class="text-success">Objectives</h1>
        <p class="text-muted">
          The Alijis Campus Library (ACL) community extension program is created to support CHMSU vision-mission i.e
          <br />
      ...
      <div class="row">
        <div class="col col-12 col-lg-6 pt-5 pb-5 col-xl-4 p-3">
          <div class="card p-5 h-100">
            ...
            <p class="mt-3">Promote extension projects through outreach engagement activity in the identified areas
              and/or barangays.</p>
          </div>
        </div>
        <div class="col col-12 col-lg-6 pt-5 pb-5 col-xl-4 p-3">
          <div class="card p-5 h-100">
            ...
            <p class="mt-3">Provide free lectures, trainings, storytelling and other related beneficial activities that
              addresses their learning needs.</p>
          </div>
        </div>
        <div class="col col-12 col-lg-6 pt-5 pb-5 col-xl-4 p-3">
          <div class="card p-5 h-100">
            ...
            <p class="mt-3">
              Coordinate with faculty members in conducting library outreach for free lectures and training that are
        ...
        <div class="col col-12 col-lg-6 pt-5 pb-5 col-xl-4 p-3">
          <div class="card p-5 h-100">
            ...
            <p class="mt-3">
              Coordinate with the college community and extension coordinator and local government units in conducting
        ...
        <div class="col col-12 col-lg-6 pt-5 pb-5 col-xl-4 p-3">
          <div class="card p-5 h-100">
            ...
            <p class="mt-3">
              Research reference consultation that provide personalized research reference consultations to assist
              community members, students, and professionals in finding
              relevant and reliable resources for their academic, professional, or personal research needs.
            </p>
          </div>
        </div>
        <div class="col col-12 col-lg-6 pt-5 pb-5 col-xl-4 p-3">
          <div class="card p-5 h-100">
            ...
            <p class="mt-3">Face-to-face tutorial on the use of subscribed databases, online library system and online
              public access catalog (OPAC).</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mt-5">
        ...
        <div class="col col-12 col-lg-6 pt-5 pb-5">
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            <img src="assets/img/reference3.png" width="100px" style="object-fit: contain" alt="" />
            <div class="d-flex flex-column gap-2 justify-content-between" style="min-height: 180px">
              <h4>Merriam Webster</h4>
              <p class="m-0">
                It is an American company that publishes reference books and is mostly known for its dictionaries. It is
                the oldest dictionary publisher in the United States.
              </p>
              <a href="https://www.merriam-webster.com/" class="view-more d-flex text-decoration-none"
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            ...
            <div class="d-flex flex-column justify-content-between gap-2 pe-4" style="min-height: 180px">
              ...
              <p class="m-0">Search in hundreds of general and specialized dictionaries at once. Great for obscure words
                or when you want to compare different dictionaries.</p>
              <a href="http://itools.com/tool/onelook-multi-dictionary-search"
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            ...
            <div class="d-flex flex-column justify-content-between gap-2 pe-4" style="min-height: 180px">
              <h4>OneLook Multi-Dictionary Search</h4>
              <p class="m-0">The only dictionary and search engine you need for computer and internet technology
                definitions.</p>
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            ...
            <div class="d-flex flex-column justify-content-between gap-2 pe-4" style="min-height: 180px">
              ...
              <p class="m-0">It provides a hypertext point-and-click interface for accessing various dictionary services
                on the Internet.</p>
        ...
        <div class="col col-12 col-lg-6 pt-5 pb-5">
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            <img src="assets/img/reference6.png" width="100px" style="object-fit: contain" alt="" />
            <div class="d-flex flex-column gap-2 justify-content-between" style="min-height: 180px">
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            ...
            <div class="d-flex flex-column justify-content-between gap-2 pe-4" style="min-height: 180px">
              ...
              <p class="m-0">
                It's an independent reference encyclopaedia aimed at professionals and students alike, documenting all
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            ...
            <div class="d-flex flex-column justify-content-between gap-2 pe-4" style="min-height: 180px">
              <h4>TEncyberpedia</h4>
              <p class="m-0">It is an electronic encyclopedia with its own content as well as over 10,000 links to the
        ...
        <div class="col col-12 col-lg-6 pt-5 pb-5">
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            <img src="assets/img/reference9.jpg" width="100px" style="object-fit: contain" alt="" />
            <div class="d-flex flex-column gap-2 justify-content-between" style="min-height: 180px">
              <h4>Google Maps</h4>
              <p class="m-0">Find local businesses, view maps and get driving directions in Google Maps</p>
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            ...
            <div class="d-flex flex-column justify-content-between gap-2 pe-4" style="min-height: 180px">
              <h4>World Atlas</h4>
              <p class="m-0">A complete atlas of the world featuring several thousand place names and colorful, accurate
                maps.</p>
              <a href="https://www.probert-encyclopaedia.co.uk/" class="view-more d-flex text-decoration-none"
                target="_blank">View More <span class="material-symbols-outlined"> trending_up </span></a>
            </div>
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            ...
            <div class="d-flex flex-column justify-content-between gap-2 pe-4" style="min-height: 180px">
              <h4>MapQuest</h4>
              <p class="m-0">
                Find directions and explore towns and cities worldwide. Users can display addresses on a map, view
        ...
        <div class="col col-12 col-lg-6 pt-5 pb-5">
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            <img src="assets/img/reference1.png" width="100px" style="object-fit: contain" alt="" />
            <div class="d-flex flex-column gap-2 justify-content-between" style="min-height: 180px">
              <h4>The World Fact Book</h4>
              <p class="m-0">
                Provides basic intelligence on the history, people, government, economy, energy, geography,
          ...
          <div class="d-flex align-items-start gap-3 mt-5" style="min-height: 180px">
            ...
            <div class="d-flex flex-column justify-content-between gap-2 pe-4" style="min-height: 180px">
              ...
              <p class="m-0">It allows searching or browsing in sports, entertainment, US, world, people, living,
                society, business & economy & technology.</p>
              <a href="https://www.infoplease.com/almanacs" class="view-more d-flex text-decoration-none"
                target="_blank">View More <span class="material-symbols-outlined"> trending_up </span></a>
            </div>
          </div>
        </div>
