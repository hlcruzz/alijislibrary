                ...
                <div class="w-100">
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-6 col-md-6 p-3">
                            <a href="./?page=sections" class="card-cont text-decoration-none">
                        ...
                        <div class="col-12 col-xl-6 col-md-6 p-3">
                            <a href="./?page=periodicals" class="card-cont text-decoration-none">
                                <div class="card rounded-4 p-4">
                        ...
                        <div class="col-12 col-xl-6 col-md-6 p-3">
                            <a href="./?page=library-news" class="card-cont text-decoration-none">
                                <div class="card rounded-4 p-4">
                        ...
                        <div class="col-12 col-xl-6 col-md-6 p-3">
                            <a href="./?page=gallery" class="card-cont text-decoration-none">
                                <div class="card rounded-4 p-4">
