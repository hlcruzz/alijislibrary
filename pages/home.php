                        ...
                        <div class="col-12 col-xl-6 col-md-6 p-3">
                            <a href="#hello" class="card-cont text-decoration-none">
                                <div class="card rounded-4 p-4">
                                    ...
                                    <h1 class="fs-5 text-start ">Newly Aquired Books</h1>
                        ...
                        <div class="col-12 col-xl-6 col-md-6 p-3">
                            <a href="#hello" class="card-cont text-decoration-none">
                                <div class="card rounded-4 p-4">
                                    ...
                                    <h1 class="fs-5 text-start ">Document Scanning Services</h1>
                                    <p class="read-more d-flex mt-3" href="">Read More <span
                                            class="material-symbols-outlined"> arrow_forward </span></p>
                                </div>
                            </a>
                        ...
                        <div class="d-flex flex-column gap-3 mt-4">
                            <div class="d-flex flex-column flex-lg-row">
                                ...
                                <div class="gratis-txt p-4 w-100">
                                    <h1 class="p-0 ps-4 fs-5">International Journal of Automotive Technology</h1>
                            ...
                            <div class="d-flex flex-column flex-lg-row-reverse">
                                ...
                                <div class="gratis-txt p-4 w-100">
                                    <h1 class="p-0 ps-4 fs-5">Journal of Information Technology Education: Research
                                        (JITE: Research)</h1>
                                    <p class="mt-5">
                            ...
                            <div class="d-flex flex-column flex-lg-row">
                                ...
                                <div class="gratis-txt p-4 w-100">
                                    <h1 class="p-0 ps-4 fs-5">Journal of Information Technology & Software Engineering
                                    </h1>
                                    <p class="mt-5">
                            ...
                            <div class="d-flex flex-column flex-lg-row-reverse">
                                ...
                                <div class="gratis-txt p-4 w-100">
                                    <h1 class="p-0 ps-4 fs-5">American Journal of Computer Science and Engineering
