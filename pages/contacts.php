...
<body class="overflow-x-hidden">
        ...
        <div class="col col-12 col-xl-7 p-0 ps-4 pe-4 d-flex pt-5">
          <div class="mt-5 m-xl-0 d-flex flex-column">
            ...
            <p class="fs-6 text-muted">
              We'd love to hear from you! Whether you have questions, feedback, or need assistance, our team is here to
            ...
            <form id="contactForm" class="d-flex flex-column gap-3 flex-grow-1 m-0">
              ...
              <div class="form-group d-flex flex-column gap-2 w-100 h-100">
                ...
                <textarea name="feedbackMsg" class="form-control h-100" id="feedbackMsg"
                  placeholder="Enter your message" style="resize: none; min-height: 200px" required></textarea>
              </div>
              <button type="submit" class="btn btn-success ps-5 pe-5" style="width: max-content">Submit</button>
            </form>
          </div>
        </div>
      </div>
  ...
  <div class="container-fluid mt-5 pt-5 pb-5" id="contact3">
    <div class="container-lg">
      <h1 class="fs-1 text-center">Frequently Asked Questions</h1>
      <div class="row mt-5">
        <div class="col col-12">
          <div class="p-4 rounded-4 bg-light mb-4 position-relative">
            <div class="d-flex justify-content-between align-items-center">
              <h2 class="fs-4">How do I borrow reading materials from the CHMSC Alijis Campus Library?</h2>
              <div>
                <span class="closeFaq faq-icon material-symbols-outlined fs-2" style="display: none;" role="button"
                  id="close1">
                  close </span>
            ...
            <div class="faq-p overflow-hidden" style="max-height: 0" id="p1">
              <p class="fst-italic">
                To borrow reading materials from the CHMSC Alijis Campus Library, students, faculty, and staff must have
                a valid, properly validated library card. Students can
                borrow up to three books from the Circulation or Filipiniana sections and unlimited fiction books for
                one week, while faculty members can borrow unlimited books
                from these sections with renewals allowed every two weeks. Administrative support staff may borrow one
                book for one week. Borrowing starts at 3:00 P.M., and
                borrowed books must be returned by 10:00 A.M. the next day to avoid overdue fines. Books can be renewed
                up to twice a semester, and overdue materials must be
                returned before borrowing new items. If you have overdue materials, you cannot borrow additional books
        ...
        <div class="col col-12">
          <div class="p-4 rounded-4 bg-light mb-4 position-relative">
            <div class="d-flex justify-content-between align-items-center">
              <h2 class="fs-4">What library services are available in CHMSC Alijis Campus Library?</h2>
              <div>
                <span class="closeFaq faq-icon material-symbols-outlined fs-2" style="display: none;" role="button"
                  id="close2">
                  close </span>
            ...
            <div class="faq-p overflow-hidden" style="max-height: 0" id="p2">
              <p class="fst-italic">
                ...
                library cards, and the returning/check-in of borrowed materials at the counter. Overnight or home use of
                books is allowed under specific guidelines for different
                groups (undergraduate students, faculty, and administrative staff). The library also provides book
                renewals, allowing books to be renewed twice a semester. For
                researchers, the library offers internet and computer-aided research services, with access to databases
                like IGI Global and Phil.elib. Reference and information
                services include chat assistance with librarians, online document delivery, bibliographic requests, and
                telephone inquiries. The library also facilitates printing
                and scanning services for library users and offers free Wi-Fi (access code available upon request).
                Additionally, referral letters are provided for faculty and
                students who wish to conduct research in neighboring libraries. The library regularly conducts virtual
                library orientation sessions for freshmen, transferees, and
                faculty. Lastly, library updates and announcements are shared via their Facebook page and email
                communications.
              </p>
            </div>
          </div>
        ...
        <div class="col col-12">
          <div class="p-4 rounded-4 bg-light mb-4 position-relative">
            <div class="d-flex justify-content-between align-items-center">
              <h2 class="fs-4">What is the penalty for overdue books?</h2>
              <div>
                <span class="closeFaq faq-icon material-symbols-outlined fs-2" style="display: none;" role="button"
                  id="close3">
                  close </span>
            ...
            <div class="faq-p overflow-hidden" style="max-height: 0" id="p3">
              <p class="fst-italic">
                The penalty for overdue books at the CHMSC Alijis Campus Library includes fines and restrictions on
                library access. For students, overdue books from the
                Circulation and Filipiniana sections are fined Php 1.00 per hour for each book returned after 10:00 A.M.
                on the due date (excluding holidays, Saturdays, and
                Sundays), while overdue fiction books incur a fine of Php 1.00 per day. Students are given a maximum of
                three (3) working days to return overdue books; if the
                books are not returned within this time, the student will be banned from library services for the rest
                of the semester, even if the book is returned or the fine
                is paid during the ban period. For researchers (outsiders), an overdue fine of Php 30.00 per day is
        ...
        <div class="col col-12">
          <div class="p-4 rounded-4 bg-light mb-4 position-relative">
            <div class="d-flex justify-content-between align-items-center">
              <h2 class="fs-4">Does the CHMSC Alijis Campus Library have a scanner?</h2>
              <div>
                <span class="closeFaq faq-icon material-symbols-outlined fs-2" style="display: none;" role="button"
                  id="close4">
                  close </span>
            ...
            <div class="faq-p overflow-hidden" style="max-height: 0" id="p4">
              <p class="fst-italic">
                Yes, the CHMSC Alijis Campus Library provides scanning services to its users. Library users, including
